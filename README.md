...
- Flint Client 0.3.0 is intentionally limited to Fabric on Minecraft 1.21.11. Its skins and capes are visible only to the local player and are not Mojang/Microsoft entitlements or server-visible cosmetics. The new in-game modules, including the game-sound-driven local audio visualizer, are automatically built but still require manual Minecraft verification.
